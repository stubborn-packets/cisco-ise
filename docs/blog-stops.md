# Blog stopping points

Write after a phase is merged to `main`. Each stop should have a cloneable artifact.
...
- Three planes: policy / inventory / exports
- One lab ISE, optional future `stage`
...
Policy sets, ranks, and creating new sets above the old ones.

## Post 7 — after Phase 6 + 8

Exceptions expire, and Git is the change window.

## What not to publish

- Employer names, hostnames, shared secrets, internal IPs
- A second environment that does not exist yet, presented as live